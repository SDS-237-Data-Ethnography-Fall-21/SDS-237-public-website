...
| Grade | Absences | Missed Journal Entries (out of 6) | Completed Mini-projects | Missed Checkpoints for Final Project^1^ | Incomplete Reading Annotations | Community Labor Points | Enrichment
|---|---|---|---|---|---|---|---|
| A | 3 or fewer | 1 or fewer | 2 + 1 substantive revision | 2 or fewer | 2 or fewer | 8 or more | 3 |
| B | 3 or fewer | 1 or fewer | 2 + 1 substantive revision | 2 or fewer | 2 or fewer | 8 or more | 0 |
| C | 4 or fewer | 2 or fewer | 1 + 1 substantive revision | 4 or fewer | 4 or fewer | 6 or more | 0 |
| D | 5 or fewer | 3 or fewer | 1, no revision             | 6 or fewer | 6 or fewer | 4 or more | 0 |
| E | 6 or more  | 4 or more  | 0                          | 7 or more  | 7 or more  | 3 or fewer| 0 |

> ^1^Note that while you can miss final project checkpoints, a final draft must be submitted on time and a final presentation must be delivered in order to pass the course.
...
| +1 | Suggest a data event for colleagues to potentially study in the #sds-237-participant-observation Slack channel | 1 |

> ^1^Note that this is separate from asking a question about the course administration or assignments in the #sds-237-questions channel.
...
> ^3^Two students will have an opportunity to summarize the three take-aways at the end of every class session. Priority will be given to students who have not had an opportunity to earn these points yet. 
...
Grading contracts have been theorized and implemented in the research of Dr. Peter Elbow
and Dr. Asao Inoue. This grading contract is adapted from their work, along with the contracts of Dr. Kate Navickas and Dr. Kati Ahern.
